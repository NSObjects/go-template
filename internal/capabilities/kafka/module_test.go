...
func TestModuleReportsEnabledWithValidConfig(t *testing.T) {
	mod := New(configs.KafkaConfig{Enabled: true, Brokers: []string{"127.0.0.1:9092"}})
	if err := mod.Validate(); err != nil {
