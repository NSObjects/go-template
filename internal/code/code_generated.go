...
// Code registry for errors declared in this package.
...
func init() {
	...
	register(ErrKafka, 500, "Kafka error")
	register(ErrExternalService, 500, "External service error")
	register(ErrBadRequest, 400, "Bad request")
	register(ErrUnauthorized, 401, "Unauthorized")
	register(ErrForbidden, 403, "Forbidden")
	...
	register(ErrAccountLocked, 403, "Account is locked")
	register(ErrAccountDisabled, 403, "Account is disabled")
	register(ErrTooManyAttempts, 403, "Too many login attempts")
